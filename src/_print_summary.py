...
def _mp_print_genomic_representation(args: Namespace) -> None:
    ...
    return None
def _print_genomic_representation(_positions_path: Path, _ploidy:int, _size_filter: tuple, _representation_filter: tuple, _print_type: str, _select_adapt_str: str) -> list:
    """
